...
These JavaScript exercises are intended to complement the JavaScript content on AppSy Learning Hub. They should only be done when instructed during the course of the curriculum.
...
5. Once you successfully finish an exercise, check AppSy's `solutions` branch to compare it with yours. 
   * You should not be checking the solution for an exercise until you finish it!
   * Keep in mind that AppSy's solution is not the only solution. Generally as long as all of the tests pass, your solution should be fine.
